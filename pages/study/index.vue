...
const recommend = ref([
  ...
  {
    image: bg,
    title: '未来3-5年企业高性能项目不可替代的语言，从基础到项目实战再到重构，真正从入门到精通',
    comments: '9',
...
<template>
  <div class="pb-15">
    <!-- 推荐内容 -->
    <Container>
      <div class="text-xl py-2 lg:(text-3xl pb-2 pt-6) font-bold">
        推荐内容
      </div>
    </Container>
    <Container>
          ...
          >
            <template #default>
              ...
              >
                ...
                <div class="i-mdi:cart lg:text-xl xl:text-3xl text-sky-400" />
              </div>
            </template>
          </Card>
        </a>
    ...
    <Container class="flex-col">
      <!-- tabs -->
      <Tabs v-model="activeIndex" :items="['Java', 'Vue', 'React', '小程序']" />
      <!-- Grid -->
      <div
      ...
      >
        ...
        <div v-for="(item, index) in [...recommend, ...recommend]" :key="index">
          <a :href="item.url" target="_blank" class="flex">
            ...
            >
              <template #default>
                <div class="mx-4 flex items-center justify-start text-gray-500 text-sm mb-4">
                  <span class="mr-2">Brian</span>|
                  <span class="ml-2">前端课程</span>
                </div>
              </template>
          ...
          >
            <template #default>
              ...
              >
                ...
                <div class="i-mdi:cart text-base lg:text-xl xl:text-3xl text-sky-400" />
              </div>
            </template>
          </Card>
        </a>
    ...
    <Container class="lt-lg:overflow-x-auto py-4">
      <div class="grid grid-cols-[repeat(4,1fr)] gap-3">
        ...
        >
          ...
          >
            <div class="bg-black bg-opacity-30 w-full h-full group-hover:display-none" />
          </div>
