...
function onSlideChange(e: SwiperType) {
  emits('change', e)
  ...
  <div class="py-4">
    ...
    <ul class="flex justify-evenly items-center w-full pb-4">
      <li
        ...
        :key="index"
        class="flex flex-col items-center cursor-pointer transition-all text-gray-400 item" :class="[
        ...
        "
      >
        <div class="text-2xl border-b-2 pb-2 px-2 line">
          {{ index + 1 }}
        </div>
        <div class="pt-4 text">
          {{ item }}
